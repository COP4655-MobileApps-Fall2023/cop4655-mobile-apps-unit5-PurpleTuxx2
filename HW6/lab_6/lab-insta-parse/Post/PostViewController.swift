        ...
        post.save { [weak self] result in
            ...
            DispatchQueue.main.async {
                ...
                case .success(let post):
                    ...
                    content.body = "You haven't posted for a while. Time to share something new."

                    let trigger = UNTimeIntervalNotificationTrigger(timeInterval: 60 * 60 * 24, repeats: false) // 24 hours
                    ...
                    if var currentUser = User.current {
                        ...
                        // Update the `lastPostedDate` and `hasUploadedPhoto` property on the user with the current date.
                        currentUser.lastPostedDate = Date()
                        currentUser.hasUploadedPhoto = true  // New line
